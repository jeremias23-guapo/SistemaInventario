...
import { formatDateSV } from '../utils/date'; // ✅ Usa tu utilitario de fecha
    ...
    <Container maxWidth="lg" sx={{ mt: 4, mb: 4 }}>
      <Box display="flex" justifyContent="space-between" alignItems="center" mb={2}>
        ...
        <Box display="flex" gap={2}>
          ...
          <Button variant="contained" onClick={() => generarOrdenCompraPDF(orden)}>
            Descargar PDF
          </Button>
        </Box>
      </Box>
      ...
      <Card sx={{ mb: 4 }}>
        <CardContent>
          <Grid container spacing={2}>
            ...
            <Grid item xs={12} md={4}>
              {/* ✅ Usa formato de fecha local (El Salvador) */}
              <Typography>
                <strong>Fecha:</strong> {formatDateSV(orden.fecha)}
              </Typography>
            </Grid>
